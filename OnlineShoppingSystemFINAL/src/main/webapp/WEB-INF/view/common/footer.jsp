<!-- footer page -->
	...
	<!-- jQuery easing -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery.easing.1.3.min.js"></script>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/searchproduct.js"></script>
	
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/editcard.js"></script>
	
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/orderproduct.js"></script>
</body>
</html>